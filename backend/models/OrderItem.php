...
class OrderItem extends \yii\db\ActiveRecord
{
    ...
    public function getProductAttr(){
        return $this->product->productAttrLabels($this->attr_mix);
    }

    /**
     * {@inheritdoc}
     * @return \backend\modules\shop\models\query\OrderItemQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \backend\modules\shop\models\query\OrderItemQuery(get_called_class());
    }
